...
#Added the new bird images
bird_wings_up_image = image.load("bird_wingsup.png")
bird_wings_mid_image = image.load("bird_wingsmid.png")
...
#Added new wing position and counter
wing_position = "up"
count = 0
...
while True:
    ...
    #Added if statements that check what image to show
    if wing_position == "up":
